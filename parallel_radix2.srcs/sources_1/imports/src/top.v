...
module top (
    ...
    // For a fully unrolled pipelined architecture,
    // we want to continuously stream data. 
    // We hold start high continuously so the pipeline remains constantly filled.
    wire start = 1'b1;
    wire fft_done;
